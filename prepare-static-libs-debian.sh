...
#cd fontconfig
#./autogen.sh || true
#./configure --prefix="$PREFIX" --enable-static --disable-shared CPPFLAGS="$CPPFLAGS" LDFLAGS="$LDFLAGS" PKG_CONFIG_PATH="$PKG_CONFIG_PATH"
#make -j$(nproc)
#make install
#cd ..
...
#ls -l $PREFIX/lib/libturbojpeg.a || true
